...
function deleteWordsByType(content, wordID) {
  ...
  fetch(
    `http://localhost:8080/deleteWord?content=${content}&wordID=${wordID}`,
    {
      method: "DELETE",
      headers: {
...
document
  .getElementById("simple-word-button")
  .addEventListener("click", () => getWordsByType("simpleWords"));
document
  .getElementById("error-word-button")
  .addEventListener("click", () => getWordsByType("errorWords"));
