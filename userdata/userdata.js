...
function getUserData() {
  ...
  fetch("http://localhost:8080/showUserData", {
    ...
    .then((data) => {
      ...
      document.getElementById("totalProgess").textContent =
        data.userData.TotalProgess;
      document.getElementById("dailyProgess").textContent =
        data.userData.DailyProgess;
      document.getElementById("totalGoal").textContent =
        data.userData.TotalGoal;
      document.getElementById("dailyGoal").textContent =
        data.userData.DailyGoal;
      document.getElementById("accuracy").textContent = data.userData.Accuracy;
      document.getElementById("learningCount").textContent =
        data.userData.LearningCount;
    })
    .catch((error) => {
